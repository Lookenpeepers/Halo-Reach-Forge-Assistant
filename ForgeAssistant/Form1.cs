...
namespace ForgeAssistant
{
    public partial class Form1 : Form
    {
        ...
        public CopyPaste CP;
        string MapName = "";
        string BasePointer = "haloreach.dll+02322178";
        List<string> types = new List<string>();
        string MapNamePointer = "haloreach.dll+2573EFF";
        ...
        private string GetType(string type)
        {
            switch (type)
            {
                ...
                case "4E":
                    {
                        return "Small Stone Column";
                    }
                case "4F":
                    {
                        return "Small Damaged Column";
                    }
                case "50":
                    {
                        return "Small Blue Column";
                    }
                case "51":
                    {
                        return "Small Red Column";
                    }
                case "52":
                    {
                        return "Large Column";
                ...
                case "63":
                    {
                        return "Large Wood Bridge";
                    }
                case "64":
                    {
                        return "Thin Wood Bridge";
                    }
                case "65":
                    {
                        return "Barricade";
                ...
                case "7C":
                    {
                        return "Steel Barrier";
                    }
                case "7D":
                    {
                        return "Steel Corner Wall";
                    }
                case "7E":
                    {
                        return "Watchtower Base";
                    }
                case "7F":
                    {
                        return "Blue Forerunner Crate";
                    }
                case "80":
                    {
                        return "Red Forerunner Crate";
                    }
                case "81":
                    {
                        return "Comm Node";
                ...
                case "83":
                    {
                        return "Open Supply Case";
                    }
                case "84":
                    {
                        return "Covenant Barricade";
                    }
                case "85":
                    {
                        return "Tube Shield";
